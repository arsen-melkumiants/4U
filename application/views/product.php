	...
	<div class="product">
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="price"><?php echo floatval($product_info['price'] + $this->shop_model->product_commission($product_info)).' '.$product_info['symbol']?></div>
					...
					<div class="actions">
						<ul>
							<li><a data-toggle="modal" data-target="#ajaxModal" href="<?php echo site_url('lift_up/'.$product_info['id'])?>"><i class="c_icon_up"></i><?php echo lang('go_to_up')?></a></li>
							<li><a data-toggle="modal" data-target="#ajaxModal" href="<?php echo site_url('mark/'.$product_info['id'])?>"><i class="c_icon_edit"></i><?php echo lang('allocate_lot')?></a></li>
							<li><a data-toggle="modal" data-target="#ajaxModal" href="<?php echo site_url('make_vip/'.$product_info['id'])?>"><i class="c_icon_star"></i><?php echo lang('make_vip')?></a></li>
						</ul>
					</div>
					<?php }?>
					<div class="info">
