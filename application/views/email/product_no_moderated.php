<html>
	<body>
		...
		<p>Узнать причину ошибки или дополнительную информацию Вы можете обратившись к администратору: <?php echo SITE_EMAIL?>.</p>
		<br />
		...
		<h4><?php echo lang('mail_product_no_moderation');?></h4>
		<p>Unfortunately your product (№<?php echo $id?>) not passed moderation.</p>
		<p>Contact the administrator for more information: <?php echo SITE_EMAIL?>.</p>
		<br />
