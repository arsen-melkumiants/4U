 ...
 */
$config['site_title']                 = defined('SITE_NAME') ? SITE_NAME : 'Test title'; // Site Title, example.com
$config['admin_email']                = defined('SITE_EMAIL') ? SITE_EMAIL : 'admin@example.com'; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['identity']                   = 'login';             // A database column which is used to login with
